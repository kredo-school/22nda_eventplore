...
document.addEventListener('DOMContentLoaded', function () {
    ...
    events.forEach(event => {
        ...
        if (eventImages.length === 0) {
            eventImageContent = `<img src="images/event-test/noimage.png" alt="no image" class="rounded-top card-img-sm w-100 mb-3">`;
    ...
    window.toggleMap = function() {
        ...
        const toggle = document.getElementById('cp_toggle');

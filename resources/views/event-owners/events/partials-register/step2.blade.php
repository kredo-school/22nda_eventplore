...
<div class="row justify-content-center mx-5 px-5">
    ...
    <div class="col-lg-12 mb-3 text-start">
        ...
        <input type="dateTime-local" name="app_deadline" id="app_deadline" class="form-control" required autocomplete="app_deadline" autofocus style="border: 1px solid #84947C">
    </div>
</div>
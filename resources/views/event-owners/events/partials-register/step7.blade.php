...
<div class="row justify-content-center mx-5 px-5 mb-3">
    <div class="col-lg-4 mb-3 text-start">
        ...
        <input type="url" name="facebook_link" id="facebook_link" class="form-control" style="border: 1px solid #84947C">
    </div>
    <div class="col-lg-4 mb-3 text-start">
        <i class="fa-brands fa-x-twitter icon-md" style="color: #0C2C04"></i>
        <input type="url" name="x_link" id="x_link" class="form-control" style="border: 1px solid #84947C">
    </div>
    <div class="col-lg-4 mb-3 text-start">
        <i class="fab fa-instagram icon-md" style="color: #0C2C04"></i>
        <input type="url" name="insta_link" id="insta_link" class="form-control" style="border: 1px solid #84947C">
    </div>
</div>
<div class="row justify-content-center mx-5 px-5">
    ...
    <div class="col-12 mb-3">
        <input type="url" name="official" id="official" class="form-control" style="border: 1px solid #84947C">
    </div>
</div>

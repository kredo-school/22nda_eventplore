                ...
                <div class="modal-body " style="font-family: EB Garamond">
                    <div class="d-flex justify-content-center align-items-center flex-column w-100">
                        ...
                        <div class="row d-flex align-items-center justify-content-between w-75">
                            ...
                            <div class="d-flex col-8">
                                <input type="text" id="address" name="address" class="form-control me-2 input" placeholder="1 Chome Marunouchi,...... ">
                            </div>
                        </div>
                        <hr class="w-100">
                        <div class="row d-flex align-items-center justify-content-between w-75">
                            ...
                            <div class="d-flex col-8">
                                <input type="number" id="phone" name="number" class="form-control input" placeholder="123-456-789">
                            </div>
                       </div>
                       <hr class="w-100">
                       <div class="row d-flex align-items-center justify-content-between w-75">
                        {{-- Email --}}
                            ...
                            <div class="d-flex col-8">
                                <input type="email" id="email" name="email" class="form-control input" placeholder="kredo@email.com">
                            </div>
                       </div>
                    </div>

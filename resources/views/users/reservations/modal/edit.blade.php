        ...
        <form action="{{ route('user.reservation.update', $reservation->id) }}" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center border-0">
                    <button type="button" class="btn btn-yellow mx-2 px-5 py-2" data-bs-dismiss="modal">Back</button>
                    <button type="submit" class="btn btn-green mx-2 px-5 py-2">Update</button>
                </div>
            </div>
        </form>
    </div>

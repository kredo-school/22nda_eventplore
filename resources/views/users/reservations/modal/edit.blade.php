        ...
        <form action="#" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center border-0">
                    <button type="button" class="btn-yellow border-0 rounded me-5 px-5 py-2" data-bs-dismiss="modal">Back</button>
                    <button type="submit" class="btn-green rounded border-0 px-5 py-2">Update</button>
                </div>
            </div>
        </form>
    </div>
